...
- 对于关于 MCP 规范的讨论或问答，使用[规范讨论](https://github.com/modelcontextprotocol/specification/discussions)
- 对于关于其他 MCP 开源组件的讨论或问答，使用[组织讨论](https://github.com/orgs/modelcontextprotocol/discussions)
